uint8_t disp_SETHOUR(uint8_t select, uint8_t batvol, uint8_t fl, uint8_t en)
{
	...
	LS027_disp_number(16, 6, 0, hour / 10 % 10, 0);	//時
	LS027_disp_number(22, 6, 0, hour % 10, 0);		//時
	LS027_disp_icon(28, 6, (uint8_t *)l_colon);		//：
	LS027_disp_number(32, 6, 0, min / 10 % 10, 0);	//分
	LS027_disp_number(38, 6, 0, min % 10, 0);			//分
